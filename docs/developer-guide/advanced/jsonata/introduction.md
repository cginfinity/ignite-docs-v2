...
![img](https://igniteresources.blob.core.windows.net/public/docs/static/assets/docs/jsonata/ignite-jsonata-flow.png)
...
![img](https://igniteresources.blob.core.windows.net/public/docs/static/assets/docs/jsonata/ignite-jsonata-node.gif)
...
![img](https://igniteresources.blob.core.windows.net/public/docs/static/assets/docs/jsonata/ignite-jsonata-node-install-1.gif)
